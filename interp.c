...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "tell",		do_tell,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
    { "mate",		do_mate,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
    { "[",		do_mate,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
    ...
    { "time",		do_time,	POS_DEAD,	 PL,  LOG_NORMAL|HELP_INFO, 1, 0, 0 },
...
/*  { "channels",	do_channels,	POS_DEAD,	 PL,  LOG_NORMAL|HELP_CONFIG, 1, 0, 0 }, */
   ...
   /* { "unalias",	do_unalias,	POS_DEAD,	 PL,  LOG_NORMAL|HELP_CONFIG, 1, 0, 0 }, */
    ...
    { "gtell",		do_gtell,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_GROUP, 1, 0, 0 },
    { ";",		do_gtell,	POS_SLEEPING,	 PL,  LOG_NORMAL, 0, 0, 0 },
    { "note",		do_note,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_OTHER, 1, 0, 0 },
    { "quiet",		do_quiet,	POS_SLEEPING, 	 PL,  LOG_NORMAL|HELP_CONFIG, 1, 0, 0 },
    { "reply",		do_reply,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
    { "say",		do_say,		POS_RESTING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
    { "'",		do_say,		POS_RESTING,	 PL,  LOG_NORMAL, 0, 0, 0 },
    { "clan",		do_clan,	POS_SLEEPING,	 PL,  LOG_NORMAL|HELP_COMM, 1, 0, 0 },
